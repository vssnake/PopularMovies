...
import com.virtu.popularmovies.data.repository.provider.utils.PollingCheck;
...
public class TestUtilities {
    ...
    static ContentValues createMovieValue() {
    ...
    static ContentValues createVariableValues(int seed){
        ContentValues testValues = new ContentValues();
    ...
    static long insertDefaultMovieValues(Context context) {
    ...
    static long insertDefaultMovieWithReviewAndVideo(Context context){
        // insert our test records into the database
        MoviesDbHelper dbHelper = new MoviesDbHelper(context);
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        ContentValues testMovieValues = TestUtilities.createMovieValue();
